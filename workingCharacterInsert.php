...
// TODO: prompt user for musical instrument, they enter it, it goes into database.
        ...
        else if($class == "Ranger")
        {
            ...
            $inventory[] = ["Shortsword", "Scale Mail", "Explorer's Pack", "Longbow", "Arrows"];
            $quantity[] = [1, 2, 1, 1, 20];
