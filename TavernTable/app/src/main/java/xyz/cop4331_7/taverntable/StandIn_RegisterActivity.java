...
public class StandIn_RegisterActivity extends AppCompatActivity
{
    Button signUpButton;
    ...
    public void configureSignUpButton() {
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(StandIn_RegisterActivity.this);
                                ...
                                public void onResponse(String response)
                                {
                                    try {
                                        ...
                                        else
                                        {
                                            ...
                                            Intent intent = new Intent(StandIn_RegisterActivity.this, SignInActivity.class);
                                            StandIn_RegisterActivity.this.startActivity(intent);
