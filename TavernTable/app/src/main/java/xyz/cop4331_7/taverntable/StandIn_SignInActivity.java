...
public class StandIn_SignInActivity extends AppCompatActivity
{
    Button signInButton;
                        ...
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                try
                                {
                                    ...
                                    {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(StandIn_SignInActivity.this);
                                    ...
                                    else
                                    {
                                        ...
                                        Intent intent = new Intent(StandIn_SignInActivity.this, StandIn_SelectUserTypeActivity.class);
